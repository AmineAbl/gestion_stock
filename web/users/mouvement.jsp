    ...
    <body>
        ...
        <div class="main-content">
            <div class="page-header">
                <h1 class="page-title">Mouvement de Stock</h1>
                <p class="page-subtitle">Gérez les entrées et sorties de votre inventaire</p>
            </div>

            <div class="card">
                <div class="card-header">
                    <h2 class="card-title"><i class="fas fa-exchange-alt"></i> Liste des Mouvements</h2>
                    <a href="Route?page=ajoutermouvement" class="btn btn-success">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="5">
                                        <div class="empty-state">
                                            ...
                                            <p>Aucun mouvement de stock disponible. Commencez par ajouter un mouvement.</p>
                                        </div>
                                    </td>
                                </tr>
                                <%
                                    ...
                                    for (MouvementStock mouvement : mouvements) {
                                        ...
                                        String badgeClass = "badge-add";
                                        String icon = "fas fa-plus";
                                        
                                        if ("retirer".equals(type)) {
                                ...
                                <tr>
                                    ...
                                    <td><strong><%= mouvement.getQuantite()%></strong></td>
                                    <td>
                                    ...
                                    <td class="actions-container">
                                        <a href="${pageContext.request.contextPath}/MouvementController?id=<%= mouvement.getId() %>&op=update" class="btn btn-primary btn-sm">
                                            <i class="fas fa-edit"></i> Modifier
                                        </a>
                                        <a href="${pageContext.request.contextPath}/MouvementController?id=<%= mouvement.getId() %>&op=delete" class="btn btn-danger btn-sm" 
