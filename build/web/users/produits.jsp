    ...
    <body>
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="sidebar-menu">
                <ul>
                    <li><a href="Route?page=produits" class="active"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
        ...
        <div class="main-content">
            ...
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title"><i class="fas fa-box"></i> Liste des Produits</h2>
                    <a href="Route?page=ajouterproduit" class="btn btn-success">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="price"><%= (int)p.getPrix() %> DH</td>
                                    <td>
                                        <span class="badge <%= stockClass %>">
                                            <i class="fas fa-cubes"></i> <%= p.getQuantite() %>
                                        </span>
                                    </td>
                                    <td>
                                        <% if(p.getCategorie() != null) { %>
                                            <span class="badge badge-category">
                                                <i class="fas fa-tag"></i> <%= p.getCategorie().getNom() %>
                                            </span>
                                        <% } else { %>
                                            <span class="badge badge-category" style="opacity: 0.6;">
                                                <i class="fas fa-tag"></i> Sans catégorie
                                            </span>
                                        <% } %>
                                    </td>
                                    <td class="actions-container">
                                        <a href="${pageContext.request.contextPath}/ProduitController?id=<%= p.getId() %>&op=update" class="btn btn-primary btn-sm">
                                            <i class="fas fa-edit"></i> Modifier
                                        </a>
                                        <a href="${pageContext.request.contextPath}/ProduitController?id=<%= p.getId() %>&op=delete" class="btn btn-danger btn-sm" 
                                ...
                                <tr>
                                    <td colspan="6">
                                        <div class="empty-state">
                                            ...
                                            <p>Aucun produit trouvé. Commencez par ajouter un produit à votre catalogue.</p>
                                        </div>
                                    </td>
                                </tr>
                                <% } %>
